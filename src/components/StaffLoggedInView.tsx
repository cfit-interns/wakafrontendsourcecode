...
const StaffLoggedInView = ({staff, onStaffLogoutSuccessful,onStaffRegisterClicked}: StaffLoginViewProps) => {
  ...
  return (
    <div style={{width:'100%'}}>
      ...
      <Button onClick={onStaffRegisterClicked} className={styles.button4}>
        Add Staff
      </Button>
